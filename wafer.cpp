...
int    POTENTIAL=0,INITCONDTYPE=0,INITSYMMETRY=0,NF=2,SAVEWAVEFNCS=0,RUNTYPE=0,CLUSTRUN=0,CLUSTSIZE=7,OUTPOT=0,EXCITEDSTATES=0,POTFILE=0;
...
int main( int argc, char *argv[] )
{
    ...
    if (nodeID == 0) {
        ...
        cout << "     \\_/\\_/ \\__,/ /   \\___|_|    Current build SHA1: " << GIT_SHA1 << endl;
        cout << "              \\__/" << endl << endl;
        print_line();
