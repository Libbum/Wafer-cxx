...
extern int DISTNUMZ,NUMX,NUMY,NUMZ,UPDATE,SNAPUPDATE,POTENTIAL,INITCONDTYPE,INITSYMMETRY,NF,SAVEWAVEFNCS,RUNTYPE,CLUSTRUN,CLUSTSIZE,OUTPOT,EXCITEDSTATES,WAVENUM,WAVEMAX;
